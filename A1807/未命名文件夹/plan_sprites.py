...
class Background(GameSprite):
    def __init__(self,is_alt = False):
        ...
        #两张图像交替循环
        #传图片
        super().__init__("/home/zwq/A1805-2/images/background.png")
        if is_alt:
...
class Enemy(GameSprite):
    ...
    def __init__(self):
        ...
        super().__init__("/home/zwq/A1805-2/images/enemy0.png")
...
class Hero(GameSprite):
    def __init__(self):
        super().__init__("/home/zwq/A1805-2/images/ying1.png",0)
...
class Bullet(GameSprite):
    ...
    def __init__(self):
        super().__init__("/home/zwq/A1805-2/images/bullet.png",-1)
    def update(self):
        super().update()
